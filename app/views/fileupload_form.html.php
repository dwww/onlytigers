					...
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-info-sign"></i> </span> <input
								type="text" class="input-xlarge" id="ptitle" name="ptitle"
					...
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-tags"></i> </span> <input
								type="text" class="input-xlarge" id="tags" name="tags"
								placeholder="Picture tags">
						</div>
					</div>
				</div-->
				...
				<div class="control-group ">
					...
					<div class="controls">
						<div class="input-prepend">
							...
							<input type="text" class="tags-input, input-xlarge" id="picture-tags" placeholder="Picture tags">
						</div>
					</div>
				</div>
				<div class="control-group ">
					...
					<div class="controls">
						<textarea class="xxlarge" id="image-description" name="image-description" rows="3" cols="30" placeholder="Image description"></textarea>
              		</div>
         		 </div>
				<div class="control-group">
